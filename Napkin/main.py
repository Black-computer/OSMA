...
def calculate_IOU(xmin2,ymin2,xmax2,ymax2,z):
    xml_path = 'D:/Abanden/experiment/zhijin/xml/xml/{}.xml'.format(str(z))
...
cap = cv2.VideoCapture('D:/Abanden/experiment/zhijin/Video/zhijin.mp4')
z = 0
object0 = 0
object1 = 0
distance_0 = 0
...
saveFile = "D:/Abanden/experiment/zhijin/RGB/{}.jpg".format(str(z))
    ...
    if z >start_frame:
                ...
                for index2, j in enumerate(contours):
                    if index2 == flag:
                        ...
                        if d_del < T:
                            ...
                            contours_grey0 = fgmask[cnt_true[20][0][1], cnt_true[20][0][0]]
                            cnt_False = contours[index2]
                            contours_grey1 = fgmask[cnt_False[20][0][1], cnt_False[20][0][0]]
                            ...
                            if d_del < (T / 2):
                                ...
                                if ((contours_grey_average_target >= Segmentation_Threshold) & (contours_grey_average_shadow < Segmentation_Threshold)):
                                    ...
                                    if (len(target_2) != 0) & (z == the_frame):
                                        ...
                                        x1 = centre_int2[0]
                                        y1 = centre_int2[1]
                                        for i in range(0, (len(target_2) // 6)):
                                            x2 = target_2[6 * i + 1]
                                            y2 = target_2[6 * i + 2]
                                            x3 = target_2[6 * i + 4]
                                            y3 = target_2[6 * i + 5]
        ...
        if (Abandon != 0) & (z>the_frame):
            ...
            for index3, i in enumerate(contours):
                ...
                if (distance_0 < 65)&(contours_grey_average_target>=Segmentation_Threshold_frame)&(d_del<0.6):
                    if distance_0 < 2:
