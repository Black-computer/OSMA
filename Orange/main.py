...
def calculate_IOU(xmin2,ymin2,xmax2,ymax2,z):
    xml_path = 'D:/Abanden/experiment/origine/xml/xml/{}.xml'.format(str(z))
...
cap = cv2.VideoCapture('D:/Abanden/experiment/origine/Video/ori.mp4')
z = 0
object0 = 0
object1 = 0
distance_0 = 0
...
saveFile = "D:/Abanden/experiment/origine/RGB/{}.jpg".format(str(z))
