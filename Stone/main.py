...
def calculate_IOU(xmin2,ymin2,xmax2,ymax2,z):
    xml_path = 'D:/Abanden/experiment/shitou/xml/xml/{}.xml'.format(str(z))
...
cap = cv2.VideoCapture('D:/Abanden/experiment/shitou/Video/stone.mp4')
z = 0
object0 = 0
object1 = 0
distance_0 = 0
    ...
    if z > start_frame:
        ...
        if (Abandon != 0) & (z>the_frame):
            ...
            for index3, i in enumerate(contours):
                ...
                if (distance_0 < 40)&(contours_grey_average_target>=Segmentation_Threshold_frame)&(d_del < 0.6):
                    if distance_0 < 1:
