...
def calculate_IOU(xmin2,ymin2,xmax2,ymax2,z):
    xml_path = 'D:/Abanden/experiment/box/xml/xml/{}.xml'.format(str(z))  # 文件路径
...
cap = cv2.VideoCapture('D:/Abanden/experiment/box/Video/box.mp4')
z = 0
object0 = 0
object1 = 0
distance_0 = 0
...
saveFile = "D:/Abanden/experiment/box/RGB/{}.jpg".format(str(z))
...
while (True):
    ...
    if z > start_frame:
        ...
        if (Abandon != 0) & (z>the_frame):
            if(FLAG_abandon != 0):
                if (FLAG_abandon >= 20) & ((distance_average / FLAG_abandon) < 1.0):
            ...
            for index3, i in enumerate(contours):
                ...
                if (distance_0 < 45)&(contours_grey_average_target>=Segmentation_Threshold_frame)&(d_del < 0.6):
