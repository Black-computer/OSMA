...
def calculate_IOU(xmin2,ymin2,xmax2,ymax2,z):
    xml_path = 'D:/Abanden/experiment/shuihu/xml/xml/{}.xml'.format(str(z))
...
cap = cv2.VideoCapture('D:/Abanden/experiment/shuihu/Video/shuihu.mp4')
z = 0
object0 = 0
object1 = 0
distance_0 = 0
                        ...
                        if d_del < T:
                            ...
                            if ((contours_grey_average_target >= Segmentation_Threshold) & (contours_grey_average_shadow < Segmentation_Threshold)):
                                ...
                                if (len(target) != 0)&(z == sec_frame):
                                    ...
                                    x1 = centre_int2[0]
                                    y1 = centre_int2[1]
                                    for i in range(0,(len(target)//6-1)):
                                        x2 = target[6*i+1]
                                        y2 = target[6*i+2]
                                        x3 = target[6*i+4]
                                        y3 = target[6*i+5]
